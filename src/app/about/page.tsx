        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 items-center justify-center gap-x-24 gap-y-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-lg">
              ...
              spirale et batteur mélangeur pour la boulangerie pâtisserie
              artisanale et industrielle.
            </p>
            <h2 className="font-bold text-3xl text-secondary">En 2022</h2>
            <p className="text-lg">
              Notre marque Durand French Mix a vu le jour
            </p>
          </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 items-center justify-center gap-x-24 gap-y-8">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-lg">
              C’est une filiale du groupe HBY Holding qui a maintenant une
              expérience de plus de quinze années dans le domaine de la
              boulangerie pâtisserie. Les principaux objectifs de notre marque
              sont de créer et de concevoir des pétrins et batteurs de qualité
